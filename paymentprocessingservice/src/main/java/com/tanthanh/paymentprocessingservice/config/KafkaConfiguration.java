package com.tanthanh.paymentprocessingservice.config;
...
public class KafkaConfiguration {
    ...
    KafkaSender<String, String> kafkaSender() {
        ...
        props.put(ProducerConfig.CLIENT_ID_CONFIG, "payment-processing-producer");
    ...
    ReceiverOptions<String, String> ReceiverOptions(){
        ...
        propsReceiver.put(ConsumerConfig.CLIENT_ID_CONFIG, "payment-processing-consumer");
        propsReceiver.put(ConsumerConfig.GROUP_ID_CONFIG, "payment-processing-group");
